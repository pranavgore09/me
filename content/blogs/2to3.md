...
draft: false
description: "How to use Python's built-in 2to3 tool to automatically translate a Python 2 codebase to Python 3 syntax with minimal manual effort."
tags: [python, migration, tools]
---
